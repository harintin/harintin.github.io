  ...
  function uo(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            pn().B && n.getBoundingClientRect().bottom >= 0 && "up" === hi.Kn(),
          i = pn().qn;
        if (i) return V(t), !1;
        if (pn().B) {
          if (e) {
            ...
            if (hi._n())
              return (
                (e = !1), hn({ qn: !0 }), hn({ N: "wheel" }), mi(), V(t), !1
              );
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = C(i, n);
                (t || o) &&
                  (f.shared.Jn || fo(!1), (f.shared.Jn = !0), (e = !0));
              }
            }),
    ...
    vn.D(Sn, function () {
      var n = Tt().credits.position || "right",
        ...
        e = '\n        <div class="fp-watermark" style="'
          ...
          .concat(
            Tt().credits.label || "Made with fullPage.js",
            "\n            </a>\n        </div>\n    "
          ),
        i = rn(dn.C),
      ...
      vn.D(yn, function () {
        ...
        hn({
          nt:
            ...
            ((u || l) &&
              ((u && e <= u.et && u.ot === t.split(n[0])[4]) || l || u.it)) ||
              !1),
        });
      });
      var n = ["-"],
